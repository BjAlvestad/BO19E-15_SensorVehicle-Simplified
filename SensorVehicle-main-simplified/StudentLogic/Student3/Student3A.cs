...
namespace StudentLogic.Student3
{
    public class Student3A : StudentLogicBase
    {
        ...
        public Student3A(IWheel wheel, IEncoders encoders, ILidarDistance lidar, IUltrasonic ultrasonic) : base(wheel)
        {
            Details = new StudentLogicDescription
            {
                ...
                Description = "This program is empty.\n" +
                              ...
                              $"All this is done in the {nameof(Student3A)}.cs file."
            };
        ...
        public override void Run(CancellationToken cancellationToken)
        {
            ...
            throw new NotImplementedException($"You must write control logic in the Run() method of \'{nameof(Student3A)}\' first.\n" +
