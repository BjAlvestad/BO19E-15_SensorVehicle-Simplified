...
namespace StudentLogic.Student2
{
    public class Student2A : StudentLogicBase
    {
        ...
        public Student2A(IWheel wheel, IEncoders encoders, ILidarDistance lidar, IUltrasonic ultrasonic) : base(wheel)
        {
            Details = new StudentLogicDescription
            {
                ...
                Description = "This program is empty.\n" +
                              ...
                              $"All this is done in the {nameof(Student2A)}.cs file."
            };
        ...
        public override void Run(CancellationToken cancellationToken)
        {
            ...
            throw new NotImplementedException($"You must write control logic in the Run() method of \'{nameof(Student2A)}\' first.\n" +
